...
author: "Md. Jannatul Nayeem"

---

## Overview

The aim of this project is to predict the manner in which participants perform a barbell lift. 
...
As a result of the preprocessing steps, able to reduce 160 variables to 54.

## Exploratory Analysis

Now that have cleaned the dataset off absolutely useless varibles, we shall look at the dependence of these variables on each other through a correlation plot. 
